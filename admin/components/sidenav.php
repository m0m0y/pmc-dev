<aside class="sidenav">
    ...
    <a class="nav-link" href="careers.php"><i class="bi bi-send-fill me-1"></i> Careers</a>
    <a class="nav-link" href="branch.php"><i class="bi bi-geo-alt-fill me-1"></i> Branches</a>
    <a class="nav-link" href="users.php"><i class="bi bi-person-fill-add me-1"></i> User</a>
