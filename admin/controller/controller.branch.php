...
switch($mode) { 
    case "getBranches":
        ...
        foreach ($getBranch as $k => $v) {
            ...
            $getBranch[$k]["branch_address"] = $v["branch_address"];
            ...
            $getBranch[$k]["action"] = "
            <center>
                <button type='button' class='primary_btn' onclick='updateUserModal(\"". $v['branch_id'] ."\", \"". $v['branch_name'] ."\", \"". $v['branch_address'] ."\", \"". $v['branch_tel'] ."\", \"". $v['branch_mob'] ."\", \"". $v['branch_fax'] ."\", \"". $v['branch_email'] ."\")', \"". $v['branch_status'] ."\")'><i class='bi bi-pencil-square'></i></button>
                <button type='button' class='danger_btn' onclick='deleteUser(\"". $v['branch_id'] ."\")'><i class='bi bi-trash-fill'></i></button>
            </center>
            ";
        }
    ...
    case "addBranch":
        ...
        if (!empty($branch_name) && !empty($branch_address) && !empty($branch_tel) && !empty($branch_mob) && !empty($branch_fax) && !empty($branch_email)) {
