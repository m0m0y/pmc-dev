        ...
        <div class="container">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="footer-info">
                    <h3>Progressive Medical Corporation</h3>
                    <p>200 C. Raymundo Avenue Caniogan, Pasig City 1606 Philippines</p>
                    <br>
                    <p><strong>Phone:</strong> +63 (2) 8656 6888</p>
                    <p><strong>Email:</strong> info@pmc.ph </p>
                    <div class="social-links mt-3">
                        <a href="https://www.youtube.com/channel/UCRVCYrGPB0wsS6RsnTd31CQ" class="youtube"><i class="bx bxl-youtube"></i></a>
                        <a href="https://www.facebook.com/pmcphofficial" class="facebook"><i class="bx bxl-facebook"></i></a>
                        <a href="https://www.instagram.com/progressivemedicalcorp/" class="instagram"><i class="bx bxl-instagram"></i></a>
